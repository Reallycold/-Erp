 ...
 * 
 */
@WebServiceClient(name = "WaybillWsService", targetNamespace = "http://impl.ws.bos.redsum.com/", wsdlLocation = "http://localhost:8084/redsun/ws/waybill?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://localhost:8084/redsun/ws/waybill?wsdl");
